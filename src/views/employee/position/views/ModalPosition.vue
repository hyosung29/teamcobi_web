<template>
  <v-dialog id="modal-position" v-model="dialog" persistent max-width="600px">
        ...
        <v-container>
          <v-form ref="rulesForm" lazy-validation>
            <v-row>
              <v-col cols="12">
                <v-text-field
                  v-model="formData.positionNumber"
                  label="직급번호*"
                  dense
                  disabled
                />
