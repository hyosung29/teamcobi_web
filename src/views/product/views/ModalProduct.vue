<template>
  <v-dialog id="modal-product" v-model="dialog" persistent max-width="600px">
      ...
      <v-card-text class="pt-5">
        <v-container>
          <v-form ref="rulesForm" lazy-validation>
            ...
            <v-row>
              <v-col cols="12">
                <v-combobox v-model="formData.category" :items="category" label="카테고리" outlined dense :rules="_rules.required"></v-combobox>
              </v-col>
            </v-row>
          <v-row>
              <v-col cols="12">
